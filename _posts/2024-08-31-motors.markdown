...
1. A very compliant and agile robot like NEO
2. Slow down the reference trajectories to reduce effective mass. Difficult for contact-rich tasks like folding clothes and prepping food in a kitchen.
3. Decouple kinematic planning and dynamic planning, where kinematic plans optimize for matching the target positions while dynamic planning optimizes to match contact forces upon collision.
